...
* What brought you to the Helium Network? 
  ...
  **From 2017, we Started the LoRa gateway construction project.
   Received technology transfer from LoRa gateway developer called SETALAB(which has supported LoRa technique to the local government of Daegu Metropolitan City in Korea.) **
